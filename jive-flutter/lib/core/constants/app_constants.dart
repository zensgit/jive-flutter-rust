...
class AppConstants {
  ...
  static const List<String> supportedCurrencies = [
    ...
    'SEK', 'NOK', 'DKK', 'KRW', 'SGD', 'HKD', 'INR', 'BRL'
  ];
  ...
  static const String notificationChannelDescription = 'General notifications from Jive';
  
  // 错误消息
  static const String errorGeneral = 'Something went wrong. Please try again.';
  static const String errorNetwork = 'Network connection failed. Please check your internet connection.';
