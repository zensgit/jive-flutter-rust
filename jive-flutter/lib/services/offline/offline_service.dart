...
class OfflineService {
  ...
  Future<String> createTransactionOffline(Transaction transaction) async {
    final localId = 'offline_${DateTime.now().millisecondsSinceEpoch}_${transaction.hashCode}';
  ...
  /// 离线更新交易
  Future<void> updateTransactionOffline(String id, Map<String, dynamic> updates) async {
    // 更新本地存储
  ...
  Future<String> createAccountOffline(Account account) async {
    final localId = 'offline_${DateTime.now().millisecondsSinceEpoch}_${account.hashCode}';
  ...
  Future<void> _loadPendingOperations() async {
    try {
      final operations = HiveConfig.getSetting<List>('pending_operations') ?? [];
